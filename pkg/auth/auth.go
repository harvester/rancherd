...
func ResetAdmin(ctx context.Context, opts *Options) error {
	if opts == nil {
		opts = &Options{}
	}
	if err := validation(*opts); err != nil {
		return err
	}
...
func validation(opts Options) error {
...
func resetAdmin(ctx context.Context, kubeconfig, password, passwordFile string) error {
